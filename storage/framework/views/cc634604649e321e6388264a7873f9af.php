        ...
        <section class="card">
            ...
            <div style="overflow-x:auto;margin-top:16px">
                <table>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $listRps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rps): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                <td><?php echo e($rps->mahasiswa->user->name); ?></td>
                                <td><?php echo e($rps->mahasiswa->nim); ?></td>
                                <td><?php echo e($rps->created_at->format('d F Y')); ?></td>
                                <td style="text-align:right">
                                    <a href="<?php echo e(route('dosen.validasi.show', $rps->id)); ?>" style="color:var(--primary);text-decoration:none;font-weight:600">Lihat Detail</a>
                                </td>
                            </tr>
...
<script>
    ...
    <?php /**PATH C:\Users\Mitra\KULIAH\SEM 3\LBE\final-web-frs\resources\views/dosen/validasi/index.blade.php ENDPATH**/ ?>