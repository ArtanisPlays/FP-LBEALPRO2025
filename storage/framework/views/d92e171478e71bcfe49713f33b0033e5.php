    ...
    <div class="page-wrapper">
      <div class="container">
        <div class="content">
            ...
            <p>
                Lengkapi data untuk mengaktifkan akun mahasiswa <strong><?php echo e($user->name); ?></strong> (<?php echo e($user->email); ?>).
            </p>
            
            <form method="POST" action="<?php echo e(route('dosen.verifikasi.approve.store', $user)); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Mitra\KULIAH\SEM 3\LBE\final-web-frs\resources\views/dosen/verifikasi/approve.blade.php ENDPATH**/ ?>