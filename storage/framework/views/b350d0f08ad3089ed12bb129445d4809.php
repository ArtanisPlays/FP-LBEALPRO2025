            ...
            <div class="grid-container">
                ...
                <div class="content-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Anda memiliki <span class="font-bold"><?php echo e($jumlahRpsMenunggu ?? 5); ?></span> mahasiswa yang memerlukan validasi RPS.
                        </p>
                        <div class="card-action">
                            <a href="<?php echo e(route('dosen.validasi.index')); ?>" class="button button-green">
                ...
                <div class="content-card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            Ada <span class="font-bold"><?php echo e($jumlahPendaftarBaru ?? 2); ?></span> pendaftar baru yang menunggu persetujuan Anda.
                        </p>
                        <div class="card-action">
                            <a href="<?php echo e(route('dosen.verifikasi.list')); ?>" class="button button-blue">
...
<?php /**PATH C:\Users\Mitra\KULIAH\SEM 3\LBE\final-web-frs\resources\views/dosen/dashboard.blade.php ENDPATH**/ ?>